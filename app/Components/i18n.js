  ...
  ua: {
    translation: {
      ...
      headHunter:{
        ...
        "HEADS": "ГОЛОВАМИ",
        "VACANCIES": "ВАКАНСII",
        "NAME1":"Junior Media Buyer",
        "DESCR1":"-МЕГА ВИСОКА бонусна сітка\n-Офісний/віддалений формат\n-Реальний вплив на робочий процес\n-Ідеально налагоджена інфраструктура\n-Все, що потрібно для твої комфортної роботи та розвитку\nГоловне завдання баєра в команді - заливатися в плюс, все інше беремо на себе",
        "NAME1":"Junior Media Buyer",
        "DESCR1":"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam odit ab corporis quaerat doloremque ut nisi optio. Voluptate, illum voluptatem?",
        "NAME1":"Junior Media Buyer",
        "DESCR1":"Consectetur adipiscing elit.",
      },
      vacancies:{
        "vac1NAME": "Junior Media Buyer",
        "vac1DSCR": "Lorem ipsum dolor sit amet",
  ...
  ru: {
    translation: {
        ...
        advantages: {
            ...
            "ABOUT_US": `
            Текст ола да текст ола да текст ола да текст ола да текст ола би<br/>
            Текст ола да текст ола да текст<br/> ола да текст ола да текст ола би 
            Текст ола да текст ола да текст ола да текст ола да текст ола би<br/>
            ола да текст ола да текст ола A a текст ола да текст ола<br/>
            да текст ола A текст ола да текст.
        `,
